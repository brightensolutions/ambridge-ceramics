  ...
  return (
    <>
      ...
      >
        ...
        <div className="container-fluid px-6 md:px-16 lg:px-20 xl:px-28 py-16 md:py-20">
          {/* Page Title - Centered */}
          <Reveal>
            <h1
              className="text-[32px] md:text-[42px] lg:text-[48px] font-black uppercase tracking-[0.25em] mb-12 leading-tight text-center"
              style={{ color: DEEP }}
            >
              Ethos Statement
            </h1>
          ...
          {/* Paragraphs - Full width, left-aligned (fluid) */}
